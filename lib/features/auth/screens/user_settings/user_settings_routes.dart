class UserSettingsRoutes {
  ...
  static const institutionSupport = '/user-settings/institution-support';
  static const managePartner = '/user-settings/manage-partner';
  static const deactivateAccess = '/user-settings/deactivate-access';

  const UserSettingsRoutes._();
}
